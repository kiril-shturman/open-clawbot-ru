...
export const SECTION_META: Record<string, { label: string; description: string }> = {
  ...
  auth: { label: "Авторизация", description: "API-ключи и профили аутентификации" },
  channels: {
    label: "Каналы",
    description: "Каналы сообщений (Telegram, Discord, Slack и т. д.)",
  },
  messages: { label: "Сообщения", description: "Обработка сообщений и настройки маршрутизации" },
  commands: { label: "Команды", description: "Пользовательские slash-команды" },
  hooks: { label: "Хуки", description: "Вебхуки и событийные хуки" },
  skills: { label: "Скиллы", description: "Пакеты скиллов и возможности" },
  tools: { label: "Инструменты", description: "Настройки инструментов (браузер, поиск и т. д.)" },
  gateway: { label: "Gateway", description: "Настройки сервера gateway (порт, auth, binding)" },
  ...
  logging: { label: "Логирование", description: "Уровни логов и настройка вывода" },
  browser: { label: "Браузер", description: "Настройки автоматизации браузера" },
  ui: { label: "UI", description: "Настройки пользовательского интерфейса" },
  ...
  broadcast: { label: "Рассылка", description: "Настройки рассылок и уведомлений" },
  audio: { label: "Аудио", description: "Настройки аудиоввода и аудиовывода" },
  session: { label: "Сессия", description: "Управление сессиями и их сохранением" },
  ...
  canvasHost: { label: "Canvas Host", description: "Отрисовка и отображение canvas" },
