...
export const en: TranslationMap = {
  ...
  slashCommands: {
    ...
    commands: {
      ...
      agents: "List agents",
      kill: "Abort sub-agents",
      skill: "Run a skill",
      steer: "Steer a sub-agent",
    },
    results: {
      new: "Starting new session...",
      reset: "Resetting session...",
      stop: "Stopping current run...",
      clear: "Chat history cleared.",
      focus: "Toggled focus mode.",
      unknownCommand: "Unknown command: `/{command}`",
      helpTitle: "Available Commands",
      helpHint: "Type `/` to open the command menu.",
      agentTag: "*(agent)*",
      ...
      more: "more",
      getModelInfoFailed: "Failed to get model info",
      modelSet: "Model set to `{model}`.",
      setModelFailed: "Failed to set model",
      currentThinkingLevel: "Current thinking level: {level}.",
      getThinkingLevelFailed: "Failed to get thinking level",
      unrecognizedThinkingLevel: 'Unrecognized thinking level "{level}". Valid levels: {options}.',
      validateThinkingLevelFailed: "Failed to validate thinking level",
      thinkingLevelSet: "Thinking level set to **{level}**.",
      setThinkingLevelFailed: "Failed to set thinking level",
      currentVerboseLevel: "Current verbose level: {level}.",
      getVerboseLevelFailed: "Failed to get verbose level",
      unrecognizedVerboseLevel:
        'Unrecognized verbose level "{level}". Valid levels: off, on, full.',
      verboseModeSet: "Verbose mode set to **{level}**.",
      setVerboseModeFailed: "Failed to set verbose mode",
      currentFastMode: "Current fast mode: {mode}.",
      getFastModeFailed: "Failed to get fast mode",
      unrecognizedFastMode: 'Unrecognized fast mode "{mode}". Valid levels: status, on, off.',
      fastModeEnabled: "Fast mode enabled.",
      fastModeDisabled: "Fast mode disabled.",
      setFastModeFailed: "Failed to set fast mode",
      noActiveSession: "No active session.",
      sessionUsageTitle: "Session Usage",
      sessionUsageInput: "Input: **{tokens}** tokens",
      sessionUsageOutput: "Output: **{tokens}** tokens",
      sessionUsageTotal: "Total: **{tokens}** tokens",
      sessionUsageContext: "Context: **{pct}%** of {tokens}",
      sessionUsageModel: "Model: `{model}`",
      getUsageFailed: "Failed to get usage",
      noAgentsConfigured: "No agents configured.",
      agentsTitle: "Agents",
      defaultMarker: "*(default)*",
      listAgentsFailed: "Failed to list agents",
      killUsage: "Usage: `/kill <id|all>`",
      noActiveSubagentSessions: "No active sub-agent sessions found.",
      noMatchingSubagentSessions: "No matching sub-agent sessions found for `{target}`.",
      noActiveSubagentRunsToAbort: "No active sub-agent runs to abort.",
      noActiveRunsMatched: "No active runs matched `{target}`.",
      abortFailedShort: "abort failed",
      abortedSubagentSessions: "Aborted {count} sub-agent sessions.",
      abortedSomeSubagentSessions: "Aborted {count} of {total} sub-agent sessions.",
      abortedMatchingSubagentSessions:
        "Aborted {count} matching sub-agent sessions for `{target}`.",
      abortedSomeMatchingSubagentSessions:
        "Aborted {count} of {total} matching sub-agent sessions for `{target}`.",
